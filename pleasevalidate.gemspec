...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "LICENSE", "Manifest.txt", "README.rdoc", "RakeFile", "bin/pleasevalidate", "cucumber.yml", "features/cli_validation.feature", "features/steps/cli_validation_steps.rb", "features/steps/helper.rb", "features/steps/validate_steps.rb", "features/validate.feature", "lib/please_validate.rb", "lib/please_validate/cli.rb", "lib/please_validate/validator.rb"]
  s.has_rdoc = true
